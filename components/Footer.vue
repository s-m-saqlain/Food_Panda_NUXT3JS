<template>
  <div class="container mx-auto mt-8 mb-6">
    <div class="sm:flex sm:mx-0 mx-auto items-center justify-between">
      <div>
        <div class="flex items center justify-between">
          <img
            src="~/assets/Logo/icon.png"
            alt="Description of the image"
            class="max-w-10 h-10 cursor-pointer"
          />
          <p class="text-2xl pl-3 text-pink-600 font-semibold cursor-pointer">
            Foodpanda
          </p>
          <span class="h-9 border border-l border-black mx-5"></span>
          <svg
            width="160"
            height="32"
            viewBox="0 0 300 64"
      ...
      <div class="flex gap-3 sm:mt-0 mt-5">
        <img
          src="~/assets/Images/Facebook.png"
          alt="Description of the image"
          class="max-w-10 h-10 border border-gray-300 cursor-pointer rounded-full p-1"
        />
        <img
          src="~/assets/Images/instagrams.png"
          alt="Description of the image"
          class="max-w-10 h-10 border border-gray-300 cursor-pointer rounded-full p-1"
        />
      </div>
