        ...
        <div class="sm:mx-12 mx-4 my-4">
          ...
          <div class="sm:flex justify-between items-center my-3">
            <div>
              ...
              />
              <span v-if="errors.fname" class="error">{{ errors.fname }}</span>
            </div>
            <div>
              <label
                for="inputField"
              ...
              <input
                ...
                class="placeholder-gray-500 w-full border border-gray-300 rounded-md p-2"
              />
              <span v-if="errors.lname" class="error">{{ errors.lname }}</span>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    registerUser(userData) {
      return axios.post(
        "https://foodpanda55.pythonanywhere.com/userapi/User/auth/signup/",
        userData
      );
    },
  },
